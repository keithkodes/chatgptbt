...
public class BluetoothLePlugin extends CordovaPlugin {
  ...
  private final int REQUEST_BLUETOOTH = 59633;
  private final int REQUEST_BLUETOOTH_ADMIN = 59634;
  ...
  public boolean execute(String action, final JSONArray args, final CallbackContext callbackContext) throws JSONException {
    ...
    } else if ("hasPermissionBt".equals(action)) {
      hasPermissionBtAction(callbackContext);
    } else if ("requestPermissionBt".equals(action)) {
      requestPermissionBtAction(callbackContext);
    } else if ("hasPermissionBtAdmin".equals(action)) {
      hasPermissionBtAdminAction(callbackContext);
    } else if ("requestPermissionBtAdmin".equals(action)) {
      requestPermissionBtAdminAction(callbackContext);
    }
  ...
  public void requestPermissionAction(CallbackContext callbackContext) {
    ...
    cordova.requestPermission(this, REQUEST_BLUETOOTH, Manifest.permission.BLUETOOTH);
    cordova.requestPermission(this, REQUEST_BLUETOOTH, Manifest.permission.BLUETOOTH_ADMIN);
   ...
   */
   ...
   public void hasPermissionBtAction(CallbackContext callbackContext) {
    JSONObject returnObj = new JSONObject();

    addProperty(returnObj, "hasPermission", Build.VERSION.SDK_INT < Build.VERSION_CODES.S || cordova.hasPermission(Manifest.permission.BLUETOOTH));

    callbackContext.success(returnObj);
  }

  public void requestPermissionBtAction(CallbackContext callbackContext) {
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
      JSONObject returnObj = new JSONObject();
      addProperty(returnObj, keyError, "requestPermission");
      addProperty(returnObj, keyMessage, logOperationUnsupported);
   ...
   */
   ...
   public void hasPermissionBtAdminAction(CallbackContext callbackContext) {
    JSONObject returnObj = new JSONObject();

    addProperty(returnObj, "hasPermission", Build.VERSION.SDK_INT < Build.VERSION_CODES.S || cordova.hasPermission(Manifest.permission.BLUETOOTH_ADMIN));

    callbackContext.success(returnObj);
  }

  public void requestPermissionBtAdminAction(CallbackContext callbackContext) {
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
      JSONObject returnObj = new JSONObject();
      addProperty(returnObj, keyError, "requestPermission");
      addProperty(returnObj, keyMessage, logOperationUnsupported);
    ...
    permissionsCallback = callbackContext;
    cordova.requestPermission(this, REQUEST_BLUETOOTH_ADMIN, Manifest.permission.BLUETOOTH_ADMIN);
  }
  ...
  public void onRequestPermissionResult(int requestCode, String[] permissions, int[] grantResults) throws JSONException {
    ...
    switch (requestCode) {
      ...
      case REQUEST_BLUETOOTH_ADMIN:
        addProperty(returnObj, "requestPermission", cordova.hasPermission(Manifest.permission.BLUETOOTH_ADMIN));
        break;
      case REQUEST_BLUETOOTH:
        addProperty(returnObj, "requestPermission", cordova.hasPermission(Manifest.permission.BLUETOOTH));
        break;
